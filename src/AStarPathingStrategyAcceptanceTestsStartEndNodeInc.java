...
public class AStarPathingStrategyAcceptanceTestsStartEndNodeInc {
    ...
    public void test01_computePath01() {
        ...
        List<java.awt.Point> expected = List.of(new java.awt.Point(3, 4), new java.awt.Point(2, 4), new java.awt.Point(1, 4), new java.awt.Point(1, 5), new java.awt.Point(1, 6), new java.awt.Point(2, 6),
                new java.awt.Point(3, 6), new java.awt.Point(4, 6), new java.awt.Point(5, 6), new java.awt.Point(5, 5), new java.awt.Point(5, 4));
    ...
    public void test02_computePath02() {
        ...
        List<java.awt.Point> expected = List.of(new java.awt.Point(5, 4), new java.awt.Point(5, 5), new java.awt.Point(5, 6), new java.awt.Point(4, 6), new java.awt.Point(3, 6), new java.awt.Point(2, 6),
                new java.awt.Point(1, 6), new java.awt.Point(1, 5), new java.awt.Point(1, 4), new java.awt.Point(2, 4), new java.awt.Point(3, 4));
        assertEquals(expected, path);
    }
    ...
    public void test03_computePath03() {
        ...
        List<java.awt.Point> expected = List.of(new java.awt.Point(3, 4), new java.awt.Point(3, 3), new java.awt.Point(3, 2), new java.awt.Point(2, 2), new java.awt.Point(2, 1), new java.awt.Point(2, 0),
                new java.awt.Point(3, 0), new java.awt.Point(4, 0), new java.awt.Point(5, 0), new java.awt.Point(5, 1), new java.awt.Point(5, 2), new java.awt.Point(5, 3), new java.awt.Point(5, 4));
        assertEquals(expected, path);
    }
    ...
    public void test04_computePath04() {
        ...
        List<java.awt.Point> expected = List.of(new java.awt.Point(5, 4), new java.awt.Point(5, 3), new java.awt.Point(5, 2), new java.awt.Point(5, 1), new java.awt.Point(5, 0), new java.awt.Point(4, 0),
                new java.awt.Point(3, 0), new java.awt.Point(2, 0), new java.awt.Point(2, 1), new java.awt.Point(2, 2), new java.awt.Point(3, 2), new java.awt.Point(3, 3), new java.awt.Point(3, 4));
        assertEquals(expected, path);
    }
    ...
    public void test07_computePath07() {
        ...
        List<java.awt.Point> expected = List.of(new java.awt.Point(3, 4), new java.awt.Point(3, 5), new java.awt.Point(3, 6), new java.awt.Point(3, 7), new java.awt.Point(3, 8), new java.awt.Point(2, 8), new java.awt.Point(1, 8),
                ...
                new java.awt.Point(6, 6), new java.awt.Point(6, 5), new java.awt.Point(6, 4), new java.awt.Point(5, 4));
        assertEquals(expected, path);
    }
    ...
    public void test12_computePath12_diag_card_neighbors() {
        ...
        java.awt.Point[] expected = new java.awt.Point[]{new java.awt.Point(5, 4), new java.awt.Point(5, 5), new java.awt.Point(4, 6), new java.awt.Point(3, 6), new java.awt.Point(2, 6),
                new java.awt.Point(1, 5), new java.awt.Point(2, 4), new java.awt.Point(3, 4)};
    ...
    public void test13_computePath13_within_reach_ish() {
        ...
        List<java.awt.Point> expected = List.of(new java.awt.Point(5, 4), new java.awt.Point(5, 5), new java.awt.Point(5, 6), new java.awt.Point(4, 6),
                new java.awt.Point(3, 6), new java.awt.Point(2, 6), new Point(2, 4));
        assertEquals(expected, path);
    }
}
